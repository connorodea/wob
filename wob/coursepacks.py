...
COURSEPACKS = {
    "stanford-cs229": (
        ...
        [
            ...
            (
                ...
                ["james", "introduction", "statistical", "learning"],
            ),
    ...
    "mit-6-036": (
        ...
        [
            ...
            (
                ...
                ["deisenroth", "mathematics", "machine", "learning"],
            ),
        ],
    ),
    "mit-6-s191": (
    ...
    "berkeley-cs188": (
        ...
        [
            (
                ...
                ["russell", "artificial", "intelligence", "modern", "approach"],
            ),
            (
                "The Elements of Statistical Learning (Hastie)",
                ["hastie", "elements", "statistical", "learning"],
    ...
    "harvard-cs50": (
        ...
        [
            ...
            (
                ...
                ["sipser", "introduction", "theory", "computation"],
            ),
            (
                "Computer Science: An Overview (Brookshear)",
                ["brookshear", "computer", "science", "overview"],
            ),
        ],
    ),
    "mit-18-06": (
        ...
        [
            ...
            (
                ...
                ["boyd", "introduction", "applied", "linear", "algebra"],
            ),
    ...
    "stanford-cs124": (
        ...
        [
            ...
            (
                "Foundations of Statistical NLP (Manning)",
                ["manning", "foundations", "statistical", "natural", "language"],
            ),
            (
                "Introduction to Information Retrieval (Manning)",
                ["manning", "introduction", "information", "retrieval"],
            ),
            ("Deep Learning with Python (Chollet)", ["chollet", "deep", "learning", "python"]),
        ],
    ),
    "deepmind-rl": (
        ...
        [
            (
                ...
                ["sutton", "reinforcement", "learning", "introduction"],
            ),
            ("Bandit Algorithms (Lattimore)", ["lattimore", "bandit", "algorithms"]),
            (
                "Algorithms for Reinforcement Learning (Szepesvari)",
                ["szepesvari", "algorithms", "reinforcement", "learning"],
            ),
            (
                "Reinforcement Learning and Optimal Control (Bertsekas)",
                ["bertsekas", "reinforcement", "optimal", "control"],
            ),
        ],
    ),
    "data-science-101": (
        ...
        [
            ...
            (
                ...
                ["bruce", "practical", "statistics", "data", "scientists"],
            ),
    ...
    "causal-inference": (
        ...
        [
            ...
            (
                ...
                ["pearl", "causal", "inference", "statistics"],
            ),
    ...
    "generative-ai": (
        ...
        [
            ...
            (
                "An Introduction to Variational Autoencoders (Kingma)",
                ["kingma", "variational", "autoencoders"],
            ),
    ...
    "mlops": (
        ...
        [
            ...
            (
                "Feature Engineering for ML (Zheng)",
                ["zheng", "feature", "engineering", "machine", "learning"],
            ),
        ],
    ),
    "pl-types": (
        ...
        [
            ...
            (
                ...
                ["harper", "practical", "foundations", "programming", "languages"],
            ),
            (
            ...
            (
                ...
                ["mitchell", "concepts", "programming", "languages"],
            ),
            (
                "Advanced Topics in Types and Programming Languages (Pierce)",
                ["pierce", "advanced", "topics", "types", "programming", "languages"],
            ),
        ],
    ),
    "ds-algorithms": (
    ...
    "compiler-construction": (
        ...
        [
            ...
            (
                ...
                ["louden", "compiler", "construction", "principles", "practice"],
            ),
            (
            ...
            (
                "Parsing Techniques: A Practical Guide (Grune)",
                ["grune", "parsing", "techniques", "practical", "guide"],
            ),
        ],
    ),
    "db-course": (
        ...
        [
            ...
            (
                ...
                ["elmasri", "fundamentals", "database", "systems"],
            ),
            (
                "Database Systems: The Complete Book (Garcia-Molina)",
                ["garcia-molina", "database", "systems", "complete", "book"],
            ),
            (
                "Readings in Database Systems (Hellerstein)",
                ["hellerstein", "readings", "database", "systems"],
            ),
            (
    ...
    "discrete-math-cs": (
        ...
        [
            ...
            (
                ...
                ["epp", "discrete", "mathematics", "applications"],
            ),
            (
                "Discrete and Combinatorial Mathematics (Grimaldi)",
                ["grimaldi", "discrete", "combinatorial", "mathematics"],
            ),
    ...
    "econ-cs": (
        ...
        [
            ...
            (
                ...
                ["cesa-bianchi", "prediction", "learning", "games"],
            ),
    ...
    "embedded-systems": (
        ...
        [
            (
                "Embedded Systems: Real-Time Interfacing to ARM Cortex-M Microcontrollers (Valvano)",
                ["valvano", "interfacing", "arm", "cortex"],
            ),
            (
            ...
            (
                "The Definitive Guide to ARM Cortex-M3 and Cortex-M4 Processors (Yiu)",
                ["yiu", "definitive", "guide", "arm", "cortex"],
            ),
        ],
    ),
    "hci-design": (
        ...
        [
            ...
            (
                "Designing Interactive Systems: A Comprehensive Guide to HCI, UX and Interaction Design (Benyon)",
                [
                    "benyon",
                    "designing",
                    "interactive",
            ...
            (
                ...
                ["shneiderman", "designing", "user", "interface", "strategies", "effective"],
            ),
    ...
    "intro-cs": (
        ...
        [
            ...
            (
                ...
                ["bryant", "computer", "systems", "programmer", "perspective"],
            ),
            (
                "Structure and Interpretation of Computer Programs (Abelson)",
                ["abelson", "structure", "interpretation", "computer", "programs"],
            ),
        ],
    ),
    "networks-course": (
        ...
        [
            (
                ...
                ["kurose", "computer", "networking", "top-down", "approach"],
            ),
            (
                "Computer Networks: A Systems Approach (Peterson)",
                ["peterson", "computer", "networks", "systems", "approach"],
            ),
    ...
    "numerics-course": (
        ...
        [
            (
                "Fundamentals of Numerical Computation (Trefethen)",
                ["trefethen", "numerical", "computation"],
            ),
            (
            ...
            (
                ...
                ["chapra", "numerical", "methods", "engineers"],
            ),
        ],
    ),
    "os-course": (
        ...
        [
            (
                ...
                ["arpaci-dusseau", "three", "easy", "pieces"],
            ),
            (
    ...
    "probability-and-randomness-for-cs": (
        ...
        [
            ...
            (
                ...
                ["feller", "introduction", "probability", "theory", "applications"],
            ),
            (
    ...
    "security-course": (
        ...
        [
            ...
            (
                "Web Security for Developers (McDonald)",
                ["mcdonald", "web", "security", "developers"],
            ),
        ],
    ),
    "signals-and-systems": (
        ...
        [
            ...
            (
                ...
                ["mitra", "computer", "based", "approach"],
            ),
            (
                "Understanding Digital Signal Processing (Lyons)",
                ["lyons", "understanding", "digital"],
            ),
            (
                "Signals and Systems: Continuous and Discrete (Ziemer & Tranter)",
                ["ziemer", "continuous", "discrete"],
            ),
        ],
    ),
    "software-arch": (
        ...
        [
            (
                ...
                ["ousterhout", "philosophy", "software", "design"],
            ),
            (
    ...
    "bioml": (
        ...
        [
            ("Bioinformatics Algorithms (Compeau)", ["compeau", "bioinformatics", "algorithms"]),
            (
                "An Introduction to Bioinformatics Algorithms (Jones)",
                ["jones", "bioinformatics", "algorithms"],
            ),
            (
                "Deep Learning for the Life Sciences (Ramsundar)",
                ["ramsundar", "deep", "learning", "life", "sciences"],
            ),
            (
                "Biological Sequence Analysis (Durbin)",
                ["durbin", "biological", "sequence", "analysis"],
            ),
        ],
    ),
    "econometrics": (
        ...
        [
            ("Mostly Harmless Econometrics (Angrist)", ["angrist", "mostly", "harmless"]),
            ("Econometric Analysis (Greene)", ["greene", "econometric", "analysis"]),
            (
                "Introductory Econometrics (Wooldridge)",
                ["wooldridge", "introductory", "econometrics"],
            ),
            ("Microeconometrics (Cameron)", ["cameron", "microeconometrics"]),
        ],
    ),
    "quantfin": (
    ...
    "operations": (
        ...
        [
            (
                ...
                ["hillier", "operations", "research"],
            ),
            ("Nonlinear Programming (Bertsekas)", ["bertsekas", "nonlinear", "programming"]),
            ("Linear Programming (Chvatal)", ["chvatal", "linear", "programming"]),
            (
                "Model Building in Mathematical Programming (Williams)",
                ["williams", "model", "building", "mathematical", "programming"],
            ),
        ],
    ),
    "spatial": (
        ...
        [
            (
                ...
                ["bivand", "spatial", "data", "analysis"],
            ),
            ("Geocomputation with R (Lovelace)", ["lovelace", "geocomputation"]),
            ("Spatial Statistics (Cressie)", ["cressie", "spatial", "statistics"]),
            (
                "Geographic Information Science and Systems (Longley)",
                ["longley", "geographic", "information", "science"],
            ),
        ],
    ),
    "swe-course": (
    ...
    "theory-cs": (
        ...
        [
            ...
            (
                ...
                ["hopcroft", "introduction", "automata", "theory"],
            ),
            (
                "Computational Complexity: A Modern Approach (Arora)",
                ["arora", "computational", "complexity"],
            ),
